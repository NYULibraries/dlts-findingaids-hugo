...
!function (e) {
  ...
  function v(e, t) {
    ...
    } else n = c(t), o = m.bind(null, n, t), r = function () {
      !function (e) {
  ...
  e.exports = function (e, t, o, r) {
    ...
    for (var i = n ? new Float32Array(11) : new Array(11), c = 0; c < 11; ++c) i[c] = a(0.1 * c, e, o);
    ...
    function u(t) {
      ...
      var l = n + 0.1 * ((t - i[r]) / (i[r + 1] - i[r])),
          c = s(l, e, o);
      return c >= 0.001 ? function (e, t, n, o) {
        for (var r = 0; r < 4; ++r) {
          var i = s(t, n, o);
          if (0 === i) return t;
          t -= (a(t, n, o) - e) / i;
        ...
        return t;
      }(t, l, e, o) : 0 === c ? l : function (e, t, n, o, r) {
        var i,
            s,
            l = 0;
  ...
  var l = function (e, t, n, o, r, i, a, s) {
    ...
    mounted: function () {
      ...
      this.observer || (this.observer = new e(this.initScrollactiveItems), this.observer.observe(this.$refs['scrollactive-nav-wrapper'], {
        childList: !0,
        subtree: !0
    ...
    methods: {
      onScroll: function (e) {
        this.currentItem = this.getItemInsideWindow(), this.currentItem !== this.lastActiveItem && (this.removeActiveClass(), this.$emit('itemchanged', e, this.currentItem, this.lastActiveItem), this.lastActiveItem = this.currentItem), this.currentItem && this.currentItem.classList.add(this.activeClass);
      },
      getItemInsideWindow: function () {
        ...
        return [].forEach.call(this.items, function (n) {
          ...
          if (r) {
            ...
            o && t.highlightFirstItem && s && (e = n), t.exact && a && s && (e = n), !t.exact && a && (e = n);
          }
        }), e;
      },
      initScrollactiveItems: function () {
        var e = this;
        this.items = this.$el.querySelectorAll('.scrollactive-item'), this.clickToScroll ? [].forEach.call(this.items, function (t) {
      ...
      handleClick: function (e) {
        ...
        o ? (this.alwaysTrack || (this.scrollContainer.removeEventListener('scroll', this.onScroll), window.cancelAnimationFrame(this.scrollAnimationFrame), this.removeActiveClass(), e.currentTarget.classList.add(this.activeClass)), this.scrollTo(o).then(function () {
          if (!t.alwaysTrack) {
            ...
            }), t.currentItem !== t.lastActiveItem && (t.$emit('itemchanged', null, t.currentItem, t.lastActiveItem), t.lastActiveItem = t.currentItem);
          }
        ...
        return new Promise(function (n) {
          ...
          window.requestAnimationFrame(function e(o) {
            ...
            var u = t.scrollOffset || t.offset,
                f = r + s(c) * (i - u);
            t.scrollContainer.scrollTo(0, f), a < t.duration ? t.scrollAnimationFrame = window.requestAnimationFrame(e) : n();
          });
        });
      },
  ...
  var d = new Vue({
    ...
    methods: {
      addNewElement: function () {
        ...
        n.innerHTML = '<a href="#section-'.concat(e, '" class="scrollactive-item nav-item">Section ').concat(e, '</a>'), document.querySelector('.nav-center').appendChild(n.firstChild);
        var o = document.createElement('div');
        o.innerHTML = '<section id="section-'.concat(e, '" class="section hero ').concat(t, ' is-fullheight">\n      <div class="container">\n      <h1 class="heading title is-1">Section ').concat(e, '</h1>\n      </div>\n      </section>\n      '), document.querySelector('main').appendChild(o.firstChild), this.elements = this.$el.querySelectorAll('.scrollactive-item');
      },
      removeElement: function () {
        if (this.numberOfElements >= 1) {
          var e = [].map.call(this.elements, function (e) {
            return e.hash;
          }).slice(-1);
          document.querySelector('.nav-center a[href="'.concat(e, '"]')).remove(), document.querySelector('main').removeChild(document.querySelector(e)), this.elements = this.$el.querySelectorAll('.scrollactive-item');
        }
      }
    }
  });
